...
Tất cả endpoint yêu cầu Bearer token. `SYSTEM_ADMIN` được seed sẵn các permission trên. Actor cấp hoặc thu hồi role luôn được lấy từ JWT/Security Context, không nhận từ request.
